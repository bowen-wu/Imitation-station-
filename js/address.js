$(function(){
    ...
    //内容开始
    var $content_right_list=$("#content .content_right").find("li");
    var $content_left_list=$("#content .content_left").children().children("li");
    var index;
    $content_right_list.click(function(){
       index=$content_right_list.index(this);
       index+=1;
        $content_left_list.eq(index).show().siblings().hide();
    });
    //内容结束
